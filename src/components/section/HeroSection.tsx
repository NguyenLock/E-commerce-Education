  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-50 via-white to-secondary-50 py-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-secondary-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-accent-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <Badge variant="primary" className="inline-flex items-center space-x-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                className="group"
              >
                <span className="group-hover:ml-1 transition-all">Xem demo</span>
              </Button>
            </div>
            ...
            <div className="flex items-center space-x-6 pt-4">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-sm text-gray-600 ml-2">4.9/5 từ 50K+ đánh giá</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-slide-up">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg animate-bounce-in" style={{ animationDelay: '0.5s' }}>
                <div className="flex items-center space-x-3">
